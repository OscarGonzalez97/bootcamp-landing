...
import { fetchBootcampRealizadoBySlug } from '@/services/querysBootcampsRealizados';
...
const Page = ({ params }: parametros) => {
    ...
    return (
        <div className='container grid gap-10 mt-4'>
            ...
            {isLoading === false && !bootcampDetail &&
                <Page404 url='/bootcampt-realizados' text='Volver a la lista'/>
            }
